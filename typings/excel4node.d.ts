declare module 'excel4node' {
  ...
  /**
   * An instance of the Workbook class contains all jsonService and parameters for the Excel Workbook.
   */
  ...
  interface WorksheetValidation {
    ...
    /**
     * A boolean value indicating whether to display a dropdown combo box for a list type jsonService validation. Defaults to true for type:list
     */
  ...
  interface RowColumnBase {
    ...
    /**
     * Add Filters to a row If not options are given to the filter function, a filter will be added to all columns that contain jsonService. Optionally, if you wish to restrict your filter to a specific range, you can specify start and end rows and columns for that range. The filter row should be included in this range.
     */
